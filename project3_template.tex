...
\includegraphics[width=\linewidth]{A_sparsity.png}
\end{minipage}
\hfill
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{O_sparsity.png}
\end{minipage}%
\end{figure}
...
\begin{figure}[H]
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_0.png}
\end{minipage}
\hfill
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_1.png}
\end{minipage}%
\end{figure}
\begin{figure}[H]
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_2.png}
\end{minipage}
\hfill
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_3.png}
\end{minipage}%
\end{figure}
\begin{figure}[H]
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_4.png}
\end{minipage}
\hfill
\begin{minipage}[H]{0.4\linewidth}
\includegraphics[width=\linewidth]{state_5.png}
\end{minipage}%
\end{figure}
